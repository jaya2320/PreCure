...
urlpatterns = [
   ...
   path("submit_forum",views.submit_forum,name="submit_forum"),
   path("forum_replies/<int:id>/",views.forum_replies,name="forum_replies"),
   path("replyPage",views.replyPage,name="replyPage"),
